// ============================================================================
// 🎬 LiveWallpaperDownloadModal.tsx — Modal de download cu reclamă pentru live wallpapers
// ============================================================================
// Pattern identic cu RingtoneDownloadModal.tsx
// Diferențe: icon Video în loc de Music2, MP4 în loc de MP3
// ============================================================================
...
interface LiveWallpaperDownloadModalProps {
  isOpen: boolean
  onClose: () => void
  wallpaper: {
    id: number
...
// ── Ad Content Component (identic cu RingtoneDownloadModal) ──────────────
    ...
    <div className="mb-6">
      ...
      >
        {isHtmlContent && htmlContent ? (
          ...
          <div className="w-full h-48 flex items-center justify-center bg-gradient-to-br from-purple-600 to-pink-600">
            <div className="text-center text-white p-4">
              <h3 className="text-base font-bold mb-1">Free Live Wallpapers</h3>
...
export function LiveWallpaperDownloadModal({
  ...
  onDownload,
  onTimerComplete,
}: LiveWallpaperDownloadModalProps) {
  const { theme } = useTheme()
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className={cn('text-sm', isDark ? 'text-gray-400' : 'text-gray-500')}>
                {userType === 'premium' ? 'Premium download' : 'Free MP4 download'}
              </p>
            </div>
          </div>
          ...
          {/* Timer sau buton Download */}
          {showAdTimer && !isCountdownComplete ? (
            <div className="text-center py-4">
              <div className="inline-flex items-center gap-3 mb-3">
                <Clock className={cn('w-6 h-6', isDark ? 'text-purple-400' : 'text-purple-600')} />
...
export default LiveWallpaperDownloadModal
