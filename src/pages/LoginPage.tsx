...
export default function LoginPage() {
  ...
  // Auto-open auth modal when showModal=1 parameter is present
  useEffect(() => {
    if (searchParams.get('showModal') === '1') {
      // Delay opening the modal to ensure component is fully mounted
      setTimeout(() => {
        onOpenAuthModal()
      }, 100)
    }
  }, [onOpenAuthModal, searchParams])
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            ...
            <button
              ...
              className="mt-6 w-full text-center text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm"
            >
              Back to login
            </button>
          </div>
