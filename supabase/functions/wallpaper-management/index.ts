  ...
  try {
    ...
    switch (action) {
      ...
      case 'create': {
        ...
        const createResponse = await fetch(`${supabaseUrl}/rest/v1/wallpapers`, {
          ...
          body: JSON.stringify({
            ...
            asset_4k_url: asset_4k_url || null,
            asset_8k_url: asset_8k_url || null,
            show_4k: show_4k || false,
            show_8k: show_8k || false,
      ...
      case 'update': {
        ...
        if (asset_4k_url !== undefined) updateData.asset_4k_url = asset_4k_url || null;
        if (asset_8k_url !== undefined) updateData.asset_8k_url = asset_8k_url || null;
        if (show_4k !== undefined) updateData.show_4k = show_4k;
        if (show_8k !== undefined) updateData.show_8k = show_8k;
